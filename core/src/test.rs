//! Some utilities for generating faux data for testing.
...
/// A mock inspection with all the basics.
...
/// Some faux people to insert into your codebase.
pub fn people() -> People {
    let inspectors = vec![
        Inspector {
            info: Person {
                name: "Bob Vance".into(),
                phone: Some("618-555-1991".into()),
                email: Some("bvance@example.io".into()),
            },
            licenses: vec![
                ("License 1".into(), "123456".into()),
                ("License 2".into(), "abcdef".into()),
